   ...
   <body>
      ...
      <div class="container"> 
        ...
        <div class="pay-method">
          <form action="<?php echo base_url().'C_dataAkun/prosesDaftarMember'?>" method="POST" name="updateAkun" enctype="multipart/form-data" >
          <div class="row">
            ...
            <div class="col-md-6"> 
              ...
              <div class="heading">
                ...
                <?php 
                if ($member[0]->member == NULL || $member[0]->member == 'No') { ?>
                
                <div class="row"> 

                  <div class="col-sm-12" >
                    <label>Daftar Member<span style="color: red;">*</span></label>
                ...
                ?>
                 ...
                 <div class="row"> 
                    ...
                    <div class="col-sm-12" style="margin-bottom: -10px !important;margin-top: -20px !important;">
                      <label>Nama Lengkap</label>
                        <input type="text" class="form-control" name="namaLengkap" value="<?php echo $member[0]->namaLengkap ?>" readonly>
                      
                    </div>

                    <div class="col-sm-12" style="margin-bottom: -10px !important;">
                      <label>Email</label>
                        <input type="email" class="form-control" name="email" parsley-type="email" value="<?php echo $member[0]->email ?>" readonly>
                      
                    </div>
              
                    <div class="col-sm-12" style="margin-bottom: -10px !important;">
                      <label>No Telepon</label>
                        <input type="number" class="form-control" name="noTelepon" value="<?php echo $member[0]->noTelepon ?>" readonly>
