    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <form method="POST" action="<?php echo base_url().'webbackend/C_dataOperator/prosesUpdateDataKonsumen'?>">
          <div class="row">
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body">
                  ...
                  <hr>
                    ...
                    <input type="hidden" class="form-control" name="idAkun" value="<?php echo $konsumen['idAkun']?>" />
                    <fieldset>
                      <div class="form-group">
                          <label>Nama Lengkap</label>
                          <input type="text" class="form-control" name="namaLengkap" value="<?php echo $konsumen['namaLengkap']?>" readonly/>
                      ...
                      <div class="form-group">
                          <label>Email</label>
                          <div>
                              <input type="email" class="form-control" name="email" value="<?php echo $konsumen['email'] ?>" readonly/>
                      ...
                      <div class="form-group">
                          ...
                          <div>
                              <input type="number" class="form-control" name="noTelepon" value="<?php echo $konsumen['noTelepon'] ?>" readonly/>
