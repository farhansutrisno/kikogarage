    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="card">
            <div class="card-body">
              <h3 class="page-title">Lihat Detail Pesan Masuk Kiko Good Garage</h3><br>
              <div class="right_col" role="main">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                    <!-- <tr>
                      <td style="width: 90px !important;">Kd Pesan Masuk</td>
                      <td><?php echo $row[0]->kdPesanMasuk ?>
                    </tr> -->
                    <tr>
                      <td style="width: 90px !important;">Nama Lengkap</td>
                      <td><?php echo $row[0]->namaLengkap ?>
                    </tr>
                    <tr>
                      <td>No. Telepon</td>
                      <td><?php echo $row[0]->noTelepon ?>
                    </tr>
                    <tr>
                      <td>Tanggal Pesan</td>
                    ...
                    <!-- <tr>
                      <td>Judul Pesan</td>
                      <td><?php echo $row[0]->judulPesan ?>
                    </tr> -->
                    <tr>
                      <td>Isi Pesan</td>
                      <td><?php echo $row[0]->isiPesan ?>
                    </tr>
                </table>
              </div>
              <br>
