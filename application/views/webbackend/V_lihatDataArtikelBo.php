          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-12 page-header-title">
                    <?php
                    echo anchor('webbackend/C_dataKiko/inputDataArtikel','Add Artikel',array('class'=>'btn btn-round btn-success'));
                    ?>
                      ...
                      <?php
                        $no=1;
                            foreach ($artikel as $key){
                              ...
                              if (empty($key->tglUpdateArtikel)) {
                                $dateUpdate = '-';
                              }else{
                                $dateUpdate = date_format (new DateTime($key->tglUpdateArtikel), 'd-M-Y H:i:s');
                              }

                              if (empty($key->tglArtikel)) {
                                $dateCreate = '-';
                              }else{
                                $dateCreate = date_format (new DateTime($key->tglArtikel), 'd-M-Y H:i:s');
                              }

                            echo "<tr>";
                                echo "<td>". $no++."</td>";
                                echo "<td>". $key->judulArtikel."</td>";
                                echo "<td>". $dateCreate."</td>";
                                echo "<td>". $dateUpdate."</td>";
                                
                                ?>
                                <td>
                                    <a href="<?php echo base_url().'webbackend/C_dataKiko/detailDataArtikelBo/'.$key->kdArtikel ?>" class="btn btn-info"> <i class="ion ion-md-eye"></i> Detail</a>
                                    <a href="<?php echo base_url().'webbackend/C_dataKiko/updateDataArtikel/'.$key->kdArtikel?>" class="btn btn-primary">
                                    <i class="ion ion-md-create"></i>Update</a>
                                    <a href="<?php echo base_url().'webbackend/C_dataKiko/deleteDataArtikel/'.$key->kdArtikel?>" class="btn btn-danger"><i class="ion ion-md-trash"></i> Delete</a>
                                </td>
                            </tr>
                        <?php } ?>
