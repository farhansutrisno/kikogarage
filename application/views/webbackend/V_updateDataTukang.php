        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Edit Data Pegawai Services</h4>
                    ...
                    <fieldset>
                      ...
                      <div class="form-group">
                       ...
                       <div>
                        <label>Foto</label>
                        <div>
                          <span><img src="<?php echo base_url().'gambar_proyek/'.$tukang['foto'] ?>" height="50px" width="60px" ></span>
          
                          <input class="form-control" type="file" name="userfile">
                          <span><i>Format file : JPG/JPEG/PNG | Maksimal Upload : 10 Mb</i></span>
              ...
              <!-- <div class="card">
                <div class="card-body">
                  <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="kelurahan" value="<?php echo $operator['kelurahan'] ?>" required/>
                          <?php echo set_value('kelurahan') ?><br><?php echo form_error('kelurahan'); ?>
                      </div>
                      <div class="form-group">
                          <label>Kecamatan</label>
                          <input type="text" class="form-control" name="kecamatan" value="<?php echo $operator['kecamatan'] ?>" required/>
                          <?php echo set_value('kecamatan') ?><br><?php echo form_error('kecamatan'); ?>
                      </div>
                      <div class="form-group">
                          <label>Kabupaten</label>
                          <input type="text" class="form-control" name="kota_kab" value="<?php echo $operator['kota_kab'] ?>" required/>
                      ...
                      <div class="form-group">
                          ...
                          <input type="number" class="form-control" name="kodePos" value="<?php echo $operator['kodePos'] ?>" required/>
                          <?php echo set_value('kodePos') ?><br><?php echo form_error('kodePos'); ?>
                      </div>
                      <div class="form-group">
                          <label>Alamat Lengkap</label>
                          <div>
                              <textarea class="form-control" name="alamatLengkap" rows="5" required><?php echo $operator['alamatLengkap']?></textarea>
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                    <fieldset>
                       <?php echo anchor('webbackend/C_dataOperator/lihatDataTukang','Back',array('class'=>'btn btn-round btn-info' ));?>
