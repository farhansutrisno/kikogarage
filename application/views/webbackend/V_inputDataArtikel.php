    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <form method="POST" action="<?php echo base_url().'webbackend/C_dataKiko/prosesInputDataArtikel'?>" enctype="multipart/form-data">
          <div class="row">

            <div class="col-lg-6">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Input Data Artikel</h4>
                  ...
                  <hr>
                    ...
                    <fieldset>
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="judul" value="<?php echo set_value('judulArtikel') ?>" required/>
                      ...
                      <div class="form-group">
                          ...
                          <div>
                              ...
                              <textarea class="form-control" name="isiArtikel" rows="7" required><?php echo set_value('isiArtikel') ?></textarea>
                              <?php echo form_error('isiArtikel'); ?>
                          </div>
                      </div>
