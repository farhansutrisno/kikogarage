      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <!-- <?php echo form_open('webbackend/C_dataOperator/prosesUpdateDataOperator'); ?> -->
           <form method="POST" action="<?php echo base_url().'webbackend/C_dataKiko/prosesUpdateDataArtikel'?>" enctype="multipart/form-data">
          <div class="row">
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Form Update Data Artikel</h4>
                  
                  <hr>
                     
                    <input type="hidden" class="form-control" name="kdArtikel" value="<?php echo $artikel['kdArtikel']?>" />
                    <fieldset>
                      <div class="form-group">
                          <label>Judul Artikel</label>
                          <input type="text" class="form-control" name="judulArtikel" value="<?php echo $artikel['judulArtikel']?>" required/>
                          <?php echo set_value('judulArtikel') ?><br><?php echo form_error('judulArtikel'); ?>
                      </div>
                      <div class="form-group">
                          <label>Isi Artikel</label>
                          <div>
                              <textarea class="form-control" name="isiArtikel" rows="5" required><?php echo $artikel['isiArtikel']?></textarea>
                              <?php echo set_value('isiArtikel') ?> <br><?php echo form_error('isiArtikel'); ?>
                          </div>
                      </div>
                      <div class="form-group">
                        <label>Tanggal Artikel</label>
                        <div>
                          <input class="form-control datepicker" style="width:335px;" size="30" data-date-format="yyyy-mm-dd" type="text" name="tglArtikel" value="<?php echo $artikel['tglArtikel'] ?>" required> <?php echo set_value('tglArtikel') ?><br><?php echo form_error('tglArtikel'); ?>
                        </div>
                      </div>
                      ...
                      <div>
                        <label>Gambar</label>
                        <div>
                          <span><img src="<?php echo base_url().'gambar_proyek/'.$artikel['gambar'] ?>" height="50px" width="60px" ></span>
