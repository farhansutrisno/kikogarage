          ...
          <li class="nav-item active">
            ...
            <div class="collapse show" id="form-elements">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item active">
                  <a class="nav-link active" href="<?php echo base_url() ?>webbackend/C_dataKiko/lihatDataGaleriBo">Galeri</a>
                </li>
                <li class="nav-item">
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body">
                  <h3 class="card-title">Input Data Galeri Photo</h3>
                  ...
                  <hr>
                    ...
                    <fieldset>
                      <div class="form-group">
                          ...
                          <?php echo form_error('judulGaleri'); ?>
                      </div>
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                    <fieldset>
                       <?php echo anchor('webbackend/C_dataKiko/lihatDataGaleriBo','Back',array('class'=>'btn btn-round btn-info' ));?>
