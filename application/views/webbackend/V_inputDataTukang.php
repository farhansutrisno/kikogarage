    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <!-- <?php echo form_open('webbackend/C_dataOperator/prosesInputDataOperator'); ?> -->
          <form method="POST" action="<?php echo base_url().'webbackend/C_dataOperator/prosesInputDataTukang'?>" name="inputDataTukang" enctype="multipart/form-data">
          <div class="row">

            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <h3 class="card-title" style="font-size: 20px !important;">Input Data Pegawai Services</h3>
                ...
                <div class="card-body">
                    <fieldset>
                      ...
                      <div class="form-group">
                          ...
                          <div>
                              <textarea class="form-control" name="alamatLengkap" rows="5" required><?php echo set_value('alamatLengkap') ?></textarea>
                              <?php echo form_error('alamatLengkap'); ?>
                          </div>
                      </div>
                      <div class="form-group">
                          <label>Kode Pos</label>
                          <input type="number" class="form-control" name="kodePos" value="<?php echo set_value('kodePos') ?>" required/>
