    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="card">
            <div class="card-body">
              <h3 class="page-title">Lihat Detail Pegawai Services <small>kiko Good Garage</small> </h3><br>
              <div class="row">
                <div class="col-md-6">
                    <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        <tr>
                          <th style="width: 10px !important;">Nama Lengkap</th>
                          <td><?php echo $row[0]->nama_lengkap ?></td>
                        </tr>
                        <tr>
                          <th>Jenis Kelamin</th>
                          <td><?php echo $row[0]->jenisKelamin ?></td>
                        </tr>
                        <tr>
                          <th>No Telepon</th>
                          <td><?php echo $row[0]->noTelepon ?></td>
                        </tr>
                        <tr>
                          <th>Status</th>
                          <td><?php 
                ...
                <div class="col-md-6">
                    ...
                    <img src="<?php echo base_url().'gambar_proyek/'.$row[0]->foto ?>" width="350px" height="400px"">
                </div>
