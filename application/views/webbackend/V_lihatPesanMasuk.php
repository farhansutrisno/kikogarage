...
<body>
    ...
    <div class="container-fluid page-body-wrapper">
          ...
          <li class="nav-item active">
            ...
            <div class="collapse show" id="form-elements">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item active">
                  <a class="nav-link active" href="<?php echo base_url() ?>webbackend/C_pesanMasuk/lihatPesanMasuk">Pesan Masuk</a>
                </li>
                <li class="nav-item">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="page-title">Lihat Pesan Masuk <small>Kiko Good Garage</small> </h5><br>
              <div class="row">
                            ...
                            foreach ($pesan as $key){
                              ...
                              if (empty($key->tglPesan)) {
                                ...
                                <td style="text-align: center !important;">
                                    ...
                                    <a href="#" onclick="myDelete(<?='\''.$key->kdPesanMasuk.'\''?>)" class="btn btn-danger"><i class="ion ion-md-trash"></i> Delete</a>
                                </td>
                            </tr>
                        <?php } ?>
          ...
          <div class="modal-content">
            <div id="login">
               <div class="modal-header" style="height: 50px !important;">
                  ...
                  <div class="col-md-11">
                  <h6 class="modal-title textBlack" align="left">Hapus Data Pesan</h6>
                </div>
                <div class="col-md-1">
               ...
               <div class="modal-body" style="height: 50px !important;">
                     ...
                     <p>Apakah anda yakin ingin menghapus data Pesan</p>  
  ...
  <script>
    function myDelete(val) {
        ...
        var kdPesanMasuk = val;
        console.log(kdPesanMasuk);
        $('#dialogrepair_box').modal('show');

        $("#btn_delete").click(function() {

            $.ajax({
                  url:"<?php echo base_url(); ?>webbackend/C_pesanMasuk/deletePesanMasuk",
                  type: 'POST',
                  dataType: "html",
                  data: {
                      kdPesanMasuk: kdPesanMasuk
                  },
