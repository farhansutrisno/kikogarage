...
<!-- Mirrored from event-theme.com/themes/html/smarttech/Blog_details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Sep 2018 15:19:28 GMT -->
<head>
    ...
    <div class="linking">
      <div class="container">
        <ol class="breadcrumb">
          ...
          <li class="active"><a href="#">Detail Artikel</a></li>
        </ol>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-9"> 
            ...
            <!-- Blog Post -->
            <div class="blog-post">
               <img class="img-responsive margin-bottom-20" style="width: 500px !important; height: 500px !important;" src="<?php echo base_url().'gambar_proyek/'.$row['gambar'] ?>" alt="" > <br><span>By: <strong>Claudio Doe</strong></span> <span><i class="fa fa-bookmark-o"></i> 
                <?php 
                if ($row['tglUpdateArtikel'] != NULL) {
                  $tanggalArtikel = date_format (new DateTime($row['tglUpdateArtikel']), 'd-M-Y H:i:s');
                }else{
                  $tanggalArtikel = date_format (new DateTime($row['tglArtikel']), 'd-M-Y H:i:s');
                }

                echo $tanggalArtikel;

                ?></span>
                <h5><?php echo $row['judulArtikel'] ?>.</h5>
                <p><?php echo $row['isiArtikel'] ?>.</p>
