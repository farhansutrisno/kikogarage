      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Beranda <i class="ion-ios-arrow-forward"></i></a></span> <span>Produk <?php echo $kategori; ?></span></p>
            <h1 class="mb-3 bread">Layanan <?php echo $kategori; ?></h1>
          </div>
        </div>
      </div>
    </section>
          ...
          <?php foreach ($produk as $key) { ?>
      			<div class="col-md-4">
      				<div class="car-wrap rounded ftco-animate">
      					...
      					<div class="text">
      						<h2 class="mb-0"><a href="car-single.html" style="text-transform: capitalize !important;"><?php echo $key->namaProduk; ?></a></h2>
